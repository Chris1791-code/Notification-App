...
/**
 * Khung danh mục gợi ý — tham chiếu cơ cấu phổ biến của các trường đại học kỹ
 * thuật tại Việt Nam. Cần đối chiếu với danh mục chính thức của HCMUT trước
 * khi dùng trong môi trường thật; đây chỉ là seed data cho môi trường phát
 * triển/demo.
 */
export const DEFAULT_CATEGORIES: Category[] = [
  { id: 'academic', key: 'academic', nameVi: 'Đào tạo', nameEn: 'Academic Affairs', order: 1 },
  { id: 'exams', key: 'exams', nameVi: 'Khảo thí & Đảm bảo chất lượng', nameEn: 'Examinations & QA', order: 2 },
  ...
  { id: 'international', key: 'international', nameVi: 'Hợp tác & Chương trình quốc tế', nameEn: 'International Programs', order: 7 },
